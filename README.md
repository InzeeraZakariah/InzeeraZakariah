...
**Specialties:**  
- Machine Learning (ML), Deep Learning (DL), Generative AI, Computer Vision (CV)  
...
- **Email Sort (Infosys Springboard)** → Interactive Gradio dashboard for email classification and prioritization engine
